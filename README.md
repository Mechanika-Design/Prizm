![Prizm logo](https://raw.githubusercontent.com/warrengalyen/Prizm/master/assets/logo_32.png) Prizm .NET
==============

[![Build status](https://img.shields.io/appveyor/ci/warrengalyen/Prizm.svg)](https://ci.appveyor.com/project/warrengalyen/Prizm)
[![Tests](https://img.shields.io/appveyor/tests/warrengalyen/Prizm.svg)](https://ci.appveyor.com/project/warrengalyen/Prizm/build/tests)

*.NET library for working with color spaces.*

The library is written in C# and released with an [MIT license](https://raw.githubusercontent.com/warrengalyen/Prizm/master/LICENSE), so feel **free to modify** or **use commercially**.

Download
--------

Binaries of the last build can be downloaded from the [Mechanika Design project page](https://www.mechanikadesign.com/Prizm/).

<sup>Prizm is CLS Compliant (to allow use in VB.NET etc.) and is built for .NET v4.5, .NET Standard 1.1 and .NET Standard 1.6.</sup>
...
The `PrizmConverter` facade can convert **from any of the [supported color spaces](#color-spaces) to any other color space**.
...
To obtain the chromaticity of a color in any color space, use conversion to **CIE xyY** color space. To obtain the color from chromaticity (xy), just add the luminance **Y** and the result is **xyY**. 
...
*For more details, see the detailed XML documentation (generated during build), or the [unit tests](https://github.com/warrengalyen/Prizm/tree/master/Prizm.Tests).*

### Macbeth ColorChecker

Prizm contains definitions of all 24 [Macbeth ColorChecker](http://en.wikipedia.org/wiki/ColorChecker) colors in sRGB, which are useful for color calibration. Access them this way:
